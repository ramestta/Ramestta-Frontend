import{d9 as y,d3 as $,d4 as l,d1 as S,d2 as x,dL as m,dd as p,dk as f,de as h,dI as u,d8 as _,dM as E,dN as C}from"./voBiVbVd.js";import{W as R}from"./CB2Wa6FI.js";import{ReownAuthentication as v}from"./DZ061ReF.js";const I=y`
  .email-sufixes {
    display: flex;
    flex-direction: row;
...
`;var O=function(o,t,i,a){var n=arguments.length,e=n<3?t:a===null?a=Object.getOwnPropertyDescriptor(t,i):a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(o,t,i,a);else for(var s=o.length-1;s>=0;s--)(r=o[s])&&(e=(n<3?r(e):n>3?r(t,i,e):r(t,i))||e);return n>3&&e&&Object.defineProperty(t,i,e),e};const D=["@gmail.com","@outlook.com","@yahoo.com","@hotmail.com","@aol.com","@icloud.com","@zoho.com"];let g=class extends ${constructor(){super(...arguments),this.email=""}render(){const t=D.filter(this.filter.bind(this)).map(this.item.bind(this));return t.length===0?null:l`<div class="email-sufixes">${t}</div>`}filter(t){if(!this.email)return!1;const i=this.email.split("@");if(i.length<2)return!0;const a=i.pop();return t.includes(a)&&t!==`@${a}`}item(t){return l`<wui-button variant="neutral" size="sm" @click=${()=>{const a=this.email.split("@");a.length>1&&a.pop();const n=a[0]+t;this.dispatchEvent(new CustomEvent("change",{detail:n,bubbles:!0,composed:!0}))}}
      >${t}</wui-button
    >`}};g.styles=[I];O([S()],g.prototype,"email",void 0);g=O([x("w3m-email-suffixes-widget")],g);const j=y`
  .recent-emails {
    display: flex;
