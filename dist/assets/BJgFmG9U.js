import{dR as x,el as ae,dd as c,df as de,c_ as $,c$ as L,d2 as w,d3 as y,d4 as d,d1 as l,dw as I,dp as _,dI as u,d0 as ue,d6 as D,dk as g,dG as j,eg as he,dX as V,dh as U,dL as E,dt as F,d9 as pe,de as O,dT as z,ed as ee,dH as me,d8 as ne,em as fe}from"./voBiVbVd.js";import"./CIZb_Cvb.js";import{S as we}from"./BlgAlrD6.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},be=$`
  :host {
    display: block;
