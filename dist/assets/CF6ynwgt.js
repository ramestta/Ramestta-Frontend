import{dv as U,dp as h,dR as k,dL as H,dq as d,dg as V,dH as z,eb as F,dI as y,dn as f,dj as R,dk as P,dl as M,dm as c,de as E,dw as Y,dr as K,ec as w,d8 as $,da as I,ed as C,dt as G,d4 as D,d5 as _,d6 as A,d7 as T,d2 as L,ee as q,d1 as X}from"./D5Je1u5Y.js";const Q=U`
  div {
    width: 100%;
  }
...
`;var B=function(e,t,i,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,i,o):s(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};const N=600,W=360,Z=64;let S=class extends h{constructor(){super(),this.bodyObserver=void 0,this.unsubscribe=[],this.iframe=document.getElementById("w3m-iframe"),this.ready=!1,this.unsubscribe.push(k.subscribeKey("open",t=>{t||this.onHideIframe()}),k.subscribeKey("shake",t=>{t?this.iframe.style.animation="w3m-shake 500ms var(--apkt-easings-ease-out-power-2)":this.iframe.style.animation="none"}))}disconnectedCallback(){var t;this.onHideIframe(),this.unsubscribe.forEach(i=>i()),(t=this.bodyObserver)==null||t.unobserve(window.document.body)}async firstUpdated(){var i;await this.syncTheme(),this.iframe.style.display="block";const t=(i=this==null?void 0:this.renderRoot)==null?void 0:i.querySelector("div");this.bodyObserver=new ResizeObserver(n=>{var s,a;const r=(s=n==null?void 0:n[0])==null?void 0:s.contentBoxSize,o=(a=r==null?void 0:r[0])==null?void 0:a.inlineSize;this.iframe.style.height=`${N}px`,t.style.height=`${N}px`,H.state.enableEmbedded?this.updateFrameSizeForEmbeddedMode():o&&o<=430?(this.iframe.style.width="100%",this.iframe.style.left="0px",this.iframe.style.bottom="0px",this.iframe.style.top="unset",this.onShowIframe()):(this.iframe.style.width=`${W}px`,this.iframe.style.left=`calc(50% - ${W/2}px)`,this.iframe.style.top=`calc(50% - ${N/2}px + ${Z/2}px)`,this.iframe.style.bottom="unset",this.onShowIframe())}),this.bodyObserver.observe(window.document.body)}render(){return d`<div data-ready=${this.ready} id="w3m-frame-container"></div>`}onShowIframe(){const t=window.innerWidth<=430;this.ready=!0,this.iframe.style.animation=t?"w3m-iframe-zoom-in-mobile 200ms var(--apkt-easings-ease-out-power-2)":"w3m-iframe-zoom-in 200ms var(--apkt-easings-ease-out-power-2)"}onHideIframe(){this.iframe.style.display="none",this.iframe.style.animation="w3m-iframe-fade-out 200ms var(--apkt-easings-ease-out-power-2)"}async syncTheme(){const t=V.getAuthConnector();if(t){const i=z.getSnapshot().themeMode,n=z.getSnapshot().themeVariables;await t.provider.syncTheme({themeVariables:n,w3mThemeVariables:F(n,i)})}}async updateFrameSizeForEmbeddedMode(){var n;const t=(n=this==null?void 0:this.renderRoot)==null?void 0:n.querySelector("div");await new Promise(r=>{setTimeout(r,300)});const i=this.getBoundingClientRect();t.style.width="100%",this.iframe.style.left=`${i.left}px`,this.iframe.style.top=`${i.top}px`,this.iframe.style.width=`${i.width}px`,this.iframe.style.height=`${i.height}px`,this.onShowIframe()}};S.styles=Q;B([y()],S.prototype,"ready",void 0);S=B([f("w3m-approve-transaction-view")],S);const J=R`
  a {
    border: none;
...
`;var b=function(e,t,i,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,i,o):s(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};let u=class extends h{constructor(){var t;super(),this.formRef=K(),this.usubscribe=[],this.name="",this.error="",this.loading=w.state.loading,this.suggestions=w.state.suggestions,this.profileName=(t=$.getAccountData())==null?void 0:t.profileName,this.onDebouncedNameInputChange=I.debounce(i=>{i.length<4?this.error="Name must be at least 4 characters long":C.isValidReownName(i)?(this.error="",w.getSuggestions(i)):this.error="The value is not a valid username"}),this.usubscribe.push(w.subscribe(i=>{this.suggestions=i.suggestions,this.loading=i.loading}),$.subscribeChainProp("accountState",i=>{this.profileName=i==null?void 0:i.profileName,i!=null&&i.profileName&&(this.error="You already own a name")}))}firstUpdated(){var t;(t=this.formRef.value)==null||t.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){var t;super.disconnectedCallback(),this.usubscribe.forEach(i=>i()),(t=this.formRef.value)==null||t.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return d`
    ...
    `}onNameInputChange(t){const i=C.validateReownName(t.detail||"");this.name=i,this.onDebouncedNameInputChange(i)}onKeyDown(t){t.key.length===1&&!C.isValidReownName(t.key)&&t.preventDefault()}templateSuggestions(){return!this.name||this.name.length<4||this.error?null:d`<wui-flex flexDirection="column" gap="1" alignItems="center">
...
`;var ae=function(e,t,i,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(r<3?s(o):r>3?s(t,i,o):s(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};let O=class extends h{render(){return d`
    ...
    </wui-flex>`}redirectToAccount(){X.replace("Account")}};O.styles=se;O=ae([f("w3m-register-account-name-success-view")],O);export{S as W3mApproveTransactionView,O as W3mRegisterAccountNameSuccess,u as W3mRegisterAccountNameView,j as W3mUpgradeWalletView};
