import{cU as e}from"./voBiVbVd.js";import{H as t,P as r,T as s,D as o,C as n,I as a,L as i}from"./DUcENubi.js";const b=()=>e.jsxs("div",{children:[e.jsx(t,{level:1,children:"RPC Endpoints"}),e.jsx(r,{children:"Ramestta provides multiple RPC (Remote Procedure Call) endpoints for interacting with the blockchain. These endpoints support standard Ethereum JSON-RPC methods and are compatible with all major web3 libraries."}),e.jsx(t,{level:2,children:"Mainnet Endpoints"}),e.jsx(t,{level:3,children:"HTTP Endpoints"}),e.jsx(s,{headers:["Endpoint","URL","Status"],rows:[["Primary","https://blockchain.ramestta.com","✅ Active"],["Backup 1","https://rpc2.ramestta.com","✅ Active"],["Backup 2","https://rpc3.ramestta.com","✅ Active"]]}),e.jsx(t,{level:3,children:"WebSocket Endpoints"}),e.jsx(s,{headers:["Endpoint","URL","Use Case"],rows:[["Primary WS","wss://ws.ramestta.com","Real-time subscriptions"]]}),e.jsx(t,{level:2,children:"Testnet Endpoints"}),e.jsx(s,{headers:["Type","URL"],rows:[["HTTP","https://testnet.ramestta.com"],["WebSocket","wss://testnet-ws.ramestta.com"]]}),e.jsx(o,{}),e.jsx(t,{level:2,children:"Making RPC Calls"}),e.jsx(t,{level:3,children:"Using cURL"}),e.jsx(n,{code:`# Get current block number
...
});`,language:"typescript",title:"websocket.ts"}),e.jsx(o,{}),e.jsx(t,{level:2,children:"High Availability Setup"}),e.jsx(r,{children:"For production applications, implement fallback providers:"}),e.jsx(n,{code:`import { ethers } from 'ethers';
