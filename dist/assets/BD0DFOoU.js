import{dR as x,el as ae,d1 as c,d3 as de,dj as $,dk as L,dn as w,dp as y,dq as d,dm as l,dw as I,dc as _,dI as u,dl as ue,ds as D,d8 as g,dG as j,eg as he,dX as V,d5 as U,dL as E,dg as F,dv as pe,d2 as O,dT as z,ed as ee,dH as me,du as ne,em as fe}from"./RZk19cD8.js";import"./Dfl7a6hl.js";import{S as we}from"./DcjAkCSv.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},be=$`
  :host {
    display: block;
