import{dL as x,ef as ae,d7 as c,d9 as de,cU as $,cV as L,cY as w,cZ as y,c_ as d,cX as l,dq as W,di as _,dC as u,cW as ue,d0 as D,de as g,dA as j,ea as he,dR as V,db as U,dF as E,dm as F,d3 as pe,d8 as O,dN as z,e7 as ee,dB as me,d2 as ne,eg as fe}from"./index-BtUOvWXV.js";import"./index-C0KhD3Xh.js";import{S as we}from"./SwapController-Dru_lYV2.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},be=$`
  :host {
    display: block;
...
//# sourceMappingURL=w3m-modal-C3M2oueu.js.map
