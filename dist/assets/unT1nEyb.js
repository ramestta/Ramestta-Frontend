import{dj as I,dm as W,dI as l,dn as O,dp as _,dg as S,dL as h,dT as T,d1 as f,de as F,dq as c,dU as D,da as C,dV as N,dc as j,dW as U,dw as y,d8 as d,d3 as P,dX as M,d5 as u,dY as A,d2 as v,dZ as z,dR as R,dH as E}from"./Cr10QW3C.js";const q=I`
  :host {
...
`;var k=function(t,e,o,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,o,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(n<3?s(i):n>3?s(e,o,i):s(e,o))||i);return n>3&&i&&Object.defineProperty(e,o,i),i};let L=class extends _{constructor(){super(),this.unsubscribe=[],this.checked=U.state.isLegalCheckboxChecked,this.unsubscribe.push(U.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var $;const{termsConditionsUrl:e,privacyPolicyUrl:o}=h.state,r=($=h.state.features)==null?void 0:$.legalCheckbox,s=!!(e||o)&&!!r&&!this.checked,a=s?-1:void 0;return c`
    ...
    `}};L.styles=B;k([l()],L.prototype,"checked",void 0);L=k([O("w3m-connect-socials-view")],L);const G=I`
  wui-logo {
    width: 80px;
    height: 80px;
