...
npm install @ramestta/staking-sdk @ramestta/bridge-sdk`}),e.jsx(t,{level:2,children:"Wallet Setup"}),e.jsx(t,{level:3,children:"MetaMask Configuration"}),e.jsx(i,{headers:["Parameter","Mainnet","Testnet"],rows:[["Network Name","Ramestta Mainnet","Ramestta Testnet"],["RPC URL","https://blockchain.ramestta.com","https://testnet.ramestta.com"],["Chain ID","1370","1371"],["Symbol","RAMA","RAMA"],["Explorer","https://ramascan.com","https://testnet.ramascan.com"]]}),e.jsx(a,{title:"Add Network Programmatically",language:"javascript",code:`// Add Ramestta to MetaMask
...
}`}),e.jsx(t,{level:2,children:"Getting Test Tokens"}),e.jsx(r,{children:"For testnet development, you'll need test RAMA tokens:"}),e.jsx(s,{ordered:!0,items:["Visit the Ramestta Faucet at https://faucet.ramestta.com","Connect your wallet or enter your address","Request test tokens (limited per 24 hours)","Wait for the transaction to confirm"]}),e.jsx(t,{level:2,children:"Verify Setup"}),e.jsx(a,{title:"Test Connection",language:"javascript",code:`const { ethers } = require('ethers');
